...
v1.0.3:
* Added FSMs to handle pause state and menuing[^1].
...
[^00]: GitHub MD sucks. It took me so many hours just to get this REAME formatted correctly and it still didn't turn out the way I wanted.
